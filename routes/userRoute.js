...
// @desc Register /sending email/OTP with reset token
// @route POST /localhost:3000/
// @access Private
// reset OTP
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const message = `Reset OTP ${OTP}, Please copy the and follow the url http://localhost:3000/verify_otp/${user.name}. The  expiration of OTP is 5 minutes`;
...
// Otp for reset password
    ...
    try {
      ...
      return res.status(200).json({ success: true, data: "OTP is sent to you Email and it expiration is 5 minutes" });
    } catch (err) {
      console.log(err);
      user.resetPasswordToken = undefined;
      user.resetPasswordExpire = undefined;
